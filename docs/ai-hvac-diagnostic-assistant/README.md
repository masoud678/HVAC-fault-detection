...
```json
{
  ...
  "nextAction": "measure_suction_line"
}
```
...
### For Dispatch Team
- ⏱️ **Time savings:** Instant diagnosis vs. 15-30 min manual
- 🎯 **Accuracy:** AI-informed recommendations reduce trial-and-error
...
### For Business
- 💰 **Revenue:** Faster diagnostics = shorter service time
...
- **Data Storage:** Google Sheets (Service_Requests sheet)
...
See:
- [`workflow-architecture.md`](workflow-architecture.md) — n8n node-by-node breakdown
- [`claude-reasoning-process.md`](claude-reasoning-process.md) — AI logic and prompting
- [`setup-guide.md`](setup-guide.md) — How to deploy this system
